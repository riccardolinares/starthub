    ...
    <div className="bg-gray-900">
      <main>
        ...
        <div className="relative isolate overflow-hidden">
          <div className="flex items-center justify-end pt-7 mx-auto max-w-7xl px-6 lg:flex lg:px-8 ">
            <p className="text-gray-400 text-sm"> Already have an account?</p>
            <Link
              href="/signin"
              className="ml-3 rounded border border-gray-400 px-2.5 py-1.5 text-xs font-medium text-gray-400 shadow-sm hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            >
              Sign in
            </Link>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-4 lg:px-8">
          <div className="border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
              &copy; {new Date().getFullYear()} {project.title}. All rights
              reserved.
            </p>
          </div>
        </div>
